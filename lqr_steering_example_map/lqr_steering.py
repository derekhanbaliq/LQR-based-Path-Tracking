...
class LQR:
    ...
    def __init__(self, dt, wheelbase, v=0.0):
        ...
        self.Q = np.diag([1.0, 0.0, 0.01, 0.0])
        self.R = np.diag([1.0])
...
class LQRSteeringController:
    ...
    def lqr_steering_control(self):
        ...
        steering = - feedback_term + feedforward_term  # feedforward_term is correct
    ...
    def calc_control_points(self):
        ...
        # print('waypoints.θ[i] = ', self.waypoints.θ[i])
        # print('self.car.θ = ', self.car.θ)
